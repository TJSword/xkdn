export const comparisonStrategies = [
    { id: 'all_weather', slug: 'all-weather', name: '全天候', color: '#00aaff', asset: '股票、国债、黄金 ETF / 基金', method: '多资产配置', allocation: '持有4只ETF', schedule: '可采用年度再平衡或相对阈值再平衡', operation: '关注配置偏离，按再平衡规则调整', risk: '多资产可能同时下跌；海外资产存在汇率风险' },
    ...
    { id: 'micro_cap', slug: 'micro-cap', name: '微盘', color: '#f0e68c', asset: '小市值股票', method: '每日排名与持仓缓冲', allocation: '10只股票，目标单只10%', schedule: '每日检查并按排名调仓', operation: '关注排名与权重调整', risk: '流动性不足、集中下跌及交易受限' }
]
